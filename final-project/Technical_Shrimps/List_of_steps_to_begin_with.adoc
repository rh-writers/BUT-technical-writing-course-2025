...
1. Search for a style guide of your choosing on the web browser. 
 + 
You can look for example at the link:https://developers.google.com/style[Google style guide]. 
 + 
Read through it and make sure you keep it opened for reference. 
 + 
You can also read our link:https://github.com/rh-writers/BUT-technical-writing-course-2025/blob/Shrimp_base/final-project/Technical_Shrimps/StyleGuides.adoc[overview of style guides].
